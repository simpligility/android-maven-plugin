...
* http://simpligility.github.io/android-maven-plugin/[Maven generated plugin documentation site]
...
* image:https://travis-ci.org/simpligilty/android-maven-plugin.png["Build Status", link="https://travis-ci.org/simpligility/android-maven-plugin"]
