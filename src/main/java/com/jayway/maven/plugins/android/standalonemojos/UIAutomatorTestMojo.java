 ...
 * Called automatically when the lifecycle reaches phase <code>integration-test</code>. Figures out whether to call
 * goals in this phase; and if so, calls <code>android:instrument</code>.
 * 
