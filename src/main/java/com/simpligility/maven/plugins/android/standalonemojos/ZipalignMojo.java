...
import com.simpligility.maven.plugins.android.configuration.Zipalign;
...
public class ZipalignMojo extends AbstractAndroidMojo 
{
     ...
     * @see com.simpligility.maven.plugins.android.configuration.Zipalign#skip
     */
     ...
     * @see com.simpligility.maven.plugins.android.configuration.Zipalign#verbose
     */
     ...
     *
     * @see com.simpligility.maven.plugins.android.configuration.Zipalign#inputApk
     */
     ...
     *
     * @see com.simpligility.maven.plugins.android.configuration.Zipalign#outputApk
     */
