 ...
 */
public interface AaptLinkCommandBuilder
{
    /**
     ...
     *
     * @return current instance of {@link AaptLinkCommandBuilder}
     */
    AaptLinkCommandBuilder makeResourcesNonConstant();
     ...
     * @return current instance of {@link AaptLinkCommandBuilder}
     */
    AaptLinkCommandBuilder makeResourcesNonConstant( boolean make );
     ...
     */
    AaptLinkCommandBuilder makePackageDirectories();
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder setResourceConstantsFolder( File path );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder setPathToAndroidManifest( File path );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addResourceDirectoryIfExists( File resourceDirectory );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addResourceDirectoriesIfExists( List<File> resourceDirectories );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addResourceDirectoriesIfExists( File[] resourceDirectories );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder autoAddOverlay();
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addRawAssetsDirectoryIfExists( File assetsFolder );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addExistingPackageToBaseIncludeSet( File path );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addConfigurations( String configurations );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder addExtraArguments( String[] extraArguments );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder setVerbose( boolean isVerbose );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder generateRTextFile( File folderForR );
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder forceOverwriteExistingFiles();
     ...
     * @return current instance of {@link AaptCommandBuilder}
     */
    AaptLinkCommandBuilder setOutputApkFile( File outputFile );
     ...
     * @return current instance of {@link AaptLinkCommandBuilder}
     */
    AaptLinkCommandBuilder renameManifestPackage( String manifestPackage );
     ...
     * @return current instance of {@link AaptLinkCommandBuilder}
     */
    AaptLinkCommandBuilder renameInstrumentationTargetPackage( String instrumentationPackage );
     ...
     * @return current instance of {@link AaptLinkCommandBuilder}
     */
    AaptLinkCommandBuilder setDebugMode( boolean isDebugMode );
}
