...
public class AarActionbarsherlockExampleSampleIT {
  ...
  public AarActionbarsherlockExampleSampleIT(MavenRuntimeBuilder builder) throws Exception {
    this.mavenRuntime = builder.build();
  }
  
  @Test
  public void buildDeployAndRun() throws Exception {
    File basedir = resources.getBasedir( "aar-actionbarsherlock-example" );
