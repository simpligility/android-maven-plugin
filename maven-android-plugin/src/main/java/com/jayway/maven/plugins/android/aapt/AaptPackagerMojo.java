 ...
 */
package com.jayway.maven.plugins.android.aapt;
 ...
 * <em>TODO: this should not need to be a separate goal. it confuses the user. it should be integrated with apk.</em>
 * @goal aaptPackage
 * @phase package
